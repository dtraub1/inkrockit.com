          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Rack Cards </span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="3"><img src="images/inner/rackcards.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px"><img src="images/inner/rackcardspict.jpg" width="274" height="172"></SPAN></FONT></p>
                          <table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Full-color printing on front side with color, B/W or blank back <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">12 pt. gloss card stock with Gloss Coating <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Standard 4&quot; x 9&quot; rack size <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Instant online ordering and digital file upload <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Great for local business promotion <br>
&nbsp; </td>
                            </tr>
                          </table>
                          <p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px">                            Rack cards are the industry standard for distribution in rack displays found at most welcome centers, many restaurants and entertainment venues worldwide.</SPAN></FONT></p></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274">&nbsp;</td>
...
<!--
	...
	{
	    iTot = iTot + (((175*colors)+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 500 && quantity <= 1000)
	{
	    iTot = iTot + (((225*colors)+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1000)
	{
	    iTot = iTot + (((225+(((quantity-1000)/1000)*120)*colors)+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/rackcards.php" method="post">
