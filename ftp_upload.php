        ...
        <td><table width="841" height="467" border="0" cellpadding="0" cellspacing="0" bgcolor="#002A72">
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/inner/step1-fade.jpg" width="179" height="51"><br>
              ...
              <img src="images/inner/step3-upload.jpg" width="179" height="35"><!-- InstanceEndEditable --><br>
                      ...
                      <tr>
                        ...
                        <td width="484">
						  <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                            <tr>
                              <td class="style16">If you have any files to upload, you can do that here. Otherwise, you can access this function later through the &quot;My Account&quot; section. </td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        ...
                        <td width="484">
						<SCRIPT LANGUAGE="php">
						   include "includes/ftp_upload.php";
                        </SCRIPT>
						</td>
                      </tr>
                      <tr>
