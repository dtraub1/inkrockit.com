<?
  ...
  if ($_POST['email'] == "") {
   ...
   print ("");
    ...
    if ($_POST['username'] != "") {	
		$Query = "SELECT * FROM ink_customers WHERE username = '" . $_POST['username'] . "'";
...
<td valign="middle" align="center">
  <p><font face="Verdana" color="#CC0000" style="font-size:14pt;font-weight:bolder;">USERNAME EXISTS!</font><br>
      <font face="Verdana" color="#00000" style="font-size:9pt;font-weight:bolder;"><br>
        The username you entered already exists.<br> 
  <br>
        If you are a current customer of InkRockit,<br>
        <br>
      please click here to go to our order form; <br>
      <br>
      OR<br>
      <br>
      click your back button and enter a different username.</font><font face="Verdana" color="#00000" style="font-size:9pt;font-weight:bolder;"><br>
        <a href="mailto:leads@inkrockit.com">leads@inkrockit.com</a></font><br>
        <br>
    </p>
  </td>
</tr>
...
//	$headers .= "From: InkRockit <dtraub@inkrockit.com>\r\n";
	...
	if ( mail("john@johnappt.com", "InkRockit Printed Samples Request", $message, $headers))
	{
	  mail("john@johnappt.com", "InkRockit Printed Samples Request", $message, $headers);
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
