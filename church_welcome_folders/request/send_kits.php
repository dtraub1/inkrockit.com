<?
  ...
  if ($_POST['email'] == "") {
   ...
   print ("");
	...
	if ( mail("leads@imageteam.com", "InkRockit Electronic Press Kit Request", $message, $headers))
	{
	  mail("clay@imageteam.com", "InkRockit Electronic Press Kit Request", $message, $headers);
?>
