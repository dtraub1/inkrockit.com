...
//    }
    ...
    if ($_nThisItemIndex == -1) {
      ...
      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 14 and pa.products_id = $_sItemNo AND pa.options_values_price = $secondsheets";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemSecondsheets[] = $myrow['products_options_values_name'];
...
<div id="paperexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select premium 24 lb. white Synergy Bond paper or standard white paper stock, two great paper options that are compatible with laser and ink jet printers. Note: if you are creating full-bleed letterhead, you should check with the manufacturer of your laser or ink jet printer to ensure that they can print on full-bleed letterhead.<ul></ul></TD></TR></TABLE></td></tr></table></div>
...
<div id="secondsheetsexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select the quantity of blank second sheets you need. Please note that the paper stock for blank second sheets will match the paper stock you select for letterhead.<ul></ul></TD></TR></TABLE></td></tr></table></div>
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Letterhead</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="2"><img src="images/inner/letterhead.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><img src="images/inner/letterheadpict.jpg" width="274" height="172"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              ...
                              <td width="260" class="style15">Full-color printing on the front side <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Two paper options: premium 24lb. Synergy Bond paper or standard <br>
                                paper stock <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Full-bleed printing available <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Optional: blank second sheets available to match letterhead<br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Optional: envelopes available to <br>
                                match letterhead <br>
&nbsp; </td>
                            </tr>
                        </table></td>
                      ...
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><P class="style16"><B>Full-color stationery printing </B>is an affordable way to make a great first impression. The design potential of full-color printing frees you from the traditional limitations of letterhead impression.</P>
                          <P class="style16">All stationery is printed on either premium 24 lb. white Synergy Bond paper or standard white paper stock. Stationery can also be purchased with second sheets and matching envelopes.</P></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
...
<!--
	...
	var secondsheets = parseFloat(document.forms["cart_quantity"].elements["secondsheets"].value);
	...
	if (quantity > 0 && quantity <= 500 && paper==2)
	{
	    iTot = iTot + ((275)*turnaround)+proof+(secondsheets*0.5)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 500 && quantity <= 1000 && paper==2)
	{
	    iTot = iTot + ((350)*turnaround)+proof+(secondsheets*0.5)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1000 && paper==2)
	{
	    iTot = iTot + ((350+(100*((quantity/1000)-1)))*turnaround)+proof+(secondsheets*0.5)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 0 && quantity <= 500 && paper==1)
	{
	    iTot = iTot + ((190)*turnaround)+proof+((secondsheets*0.5)/1.65)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 500 && quantity <= 1000 && paper==1)
	{
	    iTot = iTot + ((220)*turnaround)+proof+((secondsheets*0.5)/1.65)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1000 && paper==1)
	{
	    iTot = iTot + ((220+(50*((quantity/1000)-1)))*turnaround)+proof+((secondsheets*0.5)/1.65)
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/letterhead.php" method="post">
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Second Sheets: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('secondsheetsexp','','show')" onMouseOut="MM_showHideLayers('secondsheetsexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="secondsheets" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 14 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
