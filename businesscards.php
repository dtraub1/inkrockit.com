...
<div id="colors" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>You can choose one of three ways to print your card:<ul>
<li>Full Color on One Side, Blank White Paper on back side.
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Business Cards</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="2"><img src="images/inner/businesscards.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><img src="images/inner/businesscardspict.jpg" width="274" height="128"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              ...
                              <td width="260" class="style15">12 pt. gloss stock, UV-coated on front <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Full-color printing on front, with color, B/W or blank back <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">B/W borders and full-bleed available <br>
&nbsp; </td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274" class="style16"><B>Color printing for business cards </B>is the perfect choice, whether you need to reproduce a full-color logo or want to personalize your business card with your photograph. 3&frac12;" x 2" full-color glossy business card printing offer unlimited design possibilities.</td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
...
<!--
	...
	{
		iTot = iTot + (((.12 * quantity) * colors) * pricemultiplier) * turnaround + proof;
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1000)
	{
		iTot = iTot +  (((120+(.06 * (quantity-1000))) * colors) * pricemultiplier) * turnaround + proof;
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF">
                   <form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/businesscards.php" method="post">
                    ...
                    <table width="210" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Colors: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('colors','','show')" onMouseOut="MM_showHideLayers('colors','','hide')"></span></td>
...
// -->
			...
			?>
			  <table width="159" height="112" border="0" cellpadding="0" cellspacing="0" bgcolor="#0A478A">
                <tr>
