...
//    }
    ...
    if ($_nThisItemIndex == -1) {
      ...
      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 13 and pa.products_id = $_sItemNo AND pa.options_values_price = $upgradestock";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemUpgradestock[] = $myrow['products_options_values_name'];
...
<div id="upgradestockexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>You can choose to upgrade the paper stock:<ul>
<li>Our 12pt. Thick Paper Stock is heavy and durable.
<li>This is the same paper as our Postcards.
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Posters</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="3"><img src="images/inner/posters.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="264"><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px"><img src="images/inner/posterspict.jpg" width="274" height="172"><br>
                          </SPAN></FONT>
                          <table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">12.75 x 17.25&quot; printed on 100lb. <br>
                                gloss cover stock <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Premium 12pt. coated cover stock available <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
...
&nbsp; </td>
                            ...
                            <tr valign="top">
                              <td><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td class="style15">Great for retail placement, event promotion or reproducing original artwork <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Available in short-run quantities <br>
&nbsp; </td>
                            </tr>
                          </table>
                          <FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px">Custom sizes are available as well. We offer a variety of finishes such as spot/ flood varnishes or UV coating. &nbsp;Paper options include 80, or 100 pound text or <br>
                          80 pound cover weight, coated one side.</SPAN></FONT></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="264">&nbsp;</td>
...
<!--
	...
	var upgradestock = parseFloat(document.forms["cart_quantity"].elements["upgradestock"].value);
	...
	{
	    iTot = iTot + ((((.8 * quantity) + (upgradestock * quantity)) * turnaround)  + proof);
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 1000)
	{
	    iTot = iTot + (((450+(.15 * (quantity-1000)) + (upgradestock * quantity)) * turnaround) + proof);
		mTot = mTot + iTot / quantity;
	}
...
// -->
				  ...
				  <form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/posters.php" method="post">
                    ...
                    <table width="210" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Upgrade to 12pt Stock: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('upgradestockexp','','show')" onMouseOut="MM_showHideLayers('upgradestockexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="upgradestock" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 13 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
