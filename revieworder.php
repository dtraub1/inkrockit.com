        ...
        <td><table width="841" height="467" border="0" cellpadding="0" cellspacing="0" bgcolor="#002A72">
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/inner/step1-fade.jpg" width="179" height="51"><br>
                ...
                <img src="images/inner/step3-fade.jpg" width="179" height="35"><!-- InstanceEndEditable --><br>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="503" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
						<td colspan="2" height="42"><img src="images/inner/summarpayment.jpg" width="503" height="42"></td>
                      </tr>
                      <tr>
                        ...
                        <td width="484">
						  <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                            <tr>
                              <td class="style16">Please review the information. To make revisions to your order, use the Edit feature or the options available in the drop down menus. Using the Remove feature will remove the item from your shopping cart. </td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
						...
						<SCRIPT LANGUAGE="php">
						   ...
						   include "includes/revieworder.php";
                        </SCRIPT>
						</td>
                      </tr>
                      <tr>
                        ...
                        <td width="484">
						  <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                            <tr>
                              <td class="style17"><p><span class="style30">PRIVACY PROTECTION POLICY: The privacy and security of the information you provide is a priority at InkRockit. All personal information is kept on secured servers and will be used only for purposes relating to your transactions on this website. No information will be provided to outside sources or used for marketing or promotional purposes.</span><br>
                                      <br>
                                  </p>
                                </td>
                            </tr>
