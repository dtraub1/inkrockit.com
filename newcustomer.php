        ...
        <td><!-- InstanceBeginEditable name="MainMenu" -->
          <table width="841" height="31"  border="0" cellpadding="0" cellspacing="0" background="images/new/topbar.jpg">
            <tr>
              ...
              <td width="113" class="style3">My Account [LOGIN] </td>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="503" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="2"><img src="images/inner/customerlogin.jpg" width="503" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="484" valign="top"><p>NEW CUSTOMER</p>
                          <form name="form1" method="post" action="addcustomer.php">
                            <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                              ...
                              <tr>
                                <td>Address Identifier (ex: Home, Work) </td>
                                <td><input name="shipaddressident" type="text" id="shipaddressident"></td>
                              </tr>
                              <tr>
                                <td>Company</td>
                              ...
                              <tr>
                                <td>First Name </td>
                                <td><input name="sfirstname" type="text" id="sfirstname"></td>
                              </tr>
                              <tr>
                                <td>Last Name </td>
                                <td><input name="slastname" type="text" id="slastname"></td>
                              </tr>
                              <tr>
                                <td>Street Address </td>
                                <td><input name="streetaddress" type="text" id="streetaddress"></td>
                              </tr>
                              <tr>
                                <td>City</td>
                              ...
                              <tr>
                                <td>Address Identifier (ex: Home, Work) </td>
                                <td><input name="billaddressident" type="text" id="billaddressident"></td>
                              </tr>
                              <tr>
                                <td>Company</td>
                                <td><input name="billcompany" type="text" id="billcompany"></td>
                              </tr>
                              <tr>
                                <td>First Name </td>
                                <td><input name="bfirstname" type="text" id="bfirstname"></td>
                              </tr>
                              <tr>
                                <td>Last Name </td>
                                <td><input name="blastname" type="text" id="blastname"></td>
                              </tr>
                              <tr>
                                <td>Street Address </td>
                                <td><input name="bstreetaddress" type="text" id="bstreetaddress"></td>
                              </tr>
                              <tr>
                                <td>City</td>
                                <td><input name="bcity" type="text" id="bcity"></td>
                              </tr>
                              <tr>
                                <td>State / Province</td>
                                <td><input name="bstate" type="text" id="bstate"></td>
                              </tr>
                              <tr>
                                <td>Postal Code </td>
                                <td><input name="bpostalcode" type="text" id="bpostalcode"></td>
                              </tr>
                              <tr>
                                <td>Country</td>
                                <td><input name="bcountry" type="text" id="bcountry"></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                <td>Payment Identifier (Ex. Visa - Business) </td>
                                <td><input name="paymentident" type="text" id="paymentident"></td>
                              </tr>
                              <tr>
                                <td>Credit Card Type</td>
                                <td><input name="cctype" type="text" id="cctype"></td>
                              </tr>
                              <tr>
                                <td>Credit Card Number </td>
                                <td><input name="ccnumber" type="text" id="ccnumber"></td>
                              </tr>
                              <tr>
                                <td>Expiration Date </td>
                                <td><input name="expdate" type="text" id="expdate"></td>
                              </tr>
                              <tr>
                                <td>Security Code </td>
                                <td><input name="seccode" type="text" id="seccode"></td>
                              </tr>
                              <tr>
                                <td>Name on Card </td>
                                <td><input name="nameoncard" type="text" id="nameoncard"></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
