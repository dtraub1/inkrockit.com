...
//    }
    ...
    if ($_nThisItemIndex == -1) {
      ...
      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 7 and pa.products_id = $_sItemNo AND pa.options_values_price = $numberofpages";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemNumberofpages[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 8 and pa.products_id = $_sItemNo AND pa.options_values_price = $coverpaper";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemCoverpaper[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 5 and pa.products_id = $_sItemNo AND pa.options_values_price = $insidepagespaper";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemInsidepagespaper[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 10 and pa.products_id = $_sItemNo AND pa.options_values_price = $binding";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemBinding[] = $myrow['products_options_values_name'];
...
<div id="pagesexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select the total number of pages you need. Please note that you should count all pages as they are numbered in a book, including all inside pages and 4 pages for the cover - outside front cover, inside front cover, inside back cover and outside back cover.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="coverpaperexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>You may choose from four cover options.
<ul>
<li><b>Same as Inside Paper 4/4:</b> Printed on the same paper stock as the inside pages with full-color on both sides.
<li><b>100 lb. Gloss Cover 4/0:</b> Printed on full-color the outside with gloss coating.  The inside is blank.
<li><b>100 lb. Gloss Cover 4/1:</b> Printed on full-color the outside with gloss coating and printed black and white inside.
<li><b>100 lb. Gloss Cover 4/4:</b> Printed on full-color on the outside with gloss coating and printed full color on the inside.
</ul><ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="insidepaperexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select 100 lb. gloss text or 70 lb. matte text. 100 lb. gloss text offers a high gloss finish that is excellent for brilliant color reproduction. 70 lb. matte text is 100% recycled paper with 30% post-consumer content.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="bindingexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select one of two binding solutions offered for your printing job.
<ul>
<li>Saddle-stitched or saddle stapled option features one or more staples in the spine of the booklet.</li>
<li>Wire-O is a mechanical binding using double-looped coated metal.</li>
</ul>
<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="turnaroundexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Turnaround time for your print job begins once your order has been placed and your files have been uploaded, attached and approved. If your job is approved by 5pm Pacific Time, turnaround time begins that business day. For example, a job for three-day turnaround that you approve by 1:00 pm Tuesday will be shipped out to you by the end of business Friday. Note: Our offices are closed Saturdays, Sundays and Holidays. As a result, these days are not considered when calculating turnaround time.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="proofexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Proof is required for all catalogs and booklet printing jobs. Select one of two ways to proof your job: standard hardcopy or next day hardcopy. <br><font color=ff0000><b>*Note: The proofing process can/will delay the<br>              turnaround time of your job</b><br><br>
All proofs are sent to the billing address, unless told otherwise.</font>

<li>Customers are required to choose a proofing option on this product. Customers can select a free Standard Hardcopy Proof or, if time is of the essence, a customer can order a Next Day Hardcopy Proof for only $50. Next Day Hardcopy Proofs are the same as Standard Hardcopy Proofs but are sent via UPS next day air and have priority over other proofs.<br>
  <font color="#FF0000" size="2">Multipage Booklets have an extra $25.00 (plus tax) fee for each additional Next Day Air proofs.
  </font><br>
  <br>

<li>We include two proof copies in each shipment. One is for placement only and one is for color only. Please make sure you are approving the correct proof for placement and color at time of approval.<br><br>

<li>Customers must have successfully uploaded and attached a file(s) to their order by 9 am PST in order to ensure a next day delivery. We reserve the right to charge an additional $25 per proof if a customer requests more than one Next Day Hardcopy Proof on any order.</ul>
<ul></ul></TD></TR></TABLE></td></tr></table></div>
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Multipage Catalogs</span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/brochures.php">Brochures</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/posters.php">Posters</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/rackcards.php">Rack Cards </a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/businesscards.php">Business Cards</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/letterhead.php">Letterhead</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/envelopes.php">Envelopes</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/postcards.php">Post Cards</a></span></td>
                </tr>
              </table>
              <!-- InstanceEndEditable -->
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="3"><img src="images/inner/multipagecatalogs.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="264"><p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px"><B>Multi-Page Catalogs (11&rdquo;x17&rdquo; Flat) Stitched &amp; Folded to 8.5&rdquo;x 11&rdquo; </B></SPAN></FONT></p>
                          <p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px"><img src="images/inner/multipagecatalogspict.jpg" width="274" height="172"></SPAN></FONT></p>
                          <table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Full-Color 100lb. Cover with UV coating or Self-Cover in Black and White <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Black and White text and line art on the inside <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td class="style15">Two paper choices for inside pages: 70lb. 100% recycled matte text and 100lb. gloss text <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td class="style15">For multi-page documents, please <br>
                                only upload one multi-page PDF <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Standard Hardcopy proof included (Additional $50 for Next Day <br>
                                Hardcopy Proof) <br>
&nbsp; </td>
                            </tr>
                          </table>
                          <p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px">InkRockit&rsquo;s Multi-Page Catalogs allow you to present your company&rsquo;s entire product line from one convenient booklet. We offer you a variety of choices in paper weights and grades, number of text pages as well as bindery options and finishes such as spot or flood varnishes or UV coatings. &nbsp;Some of the options available are self-cover catalogs utilizing 70 pound, coated two side text weight paper or an 80 pound, coated two side cover with 70 pound, coated two side, text pages.</SPAN></FONT></p></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="264">&nbsp;</td>
...
<!--
	...
	var numberofpages = parseFloat(document.forms["cart_quantity"].elements["numberofpages"].value);
	var coverpaper = parseFloat(document.forms["cart_quantity"].elements["coverpaper"].value);
	var coverpaperindex = parseFloat(document.forms["cart_quantity"].elements["coverpaper"].selectedIndex);
	var insidepagespaper = parseFloat(document.forms["cart_quantity"].elements["insidepagespaper"].value);
	var binding = parseFloat(document.forms["cart_quantity"].elements["binding"].value);
	...
	if (quantity > 0 && quantity <= 250 && coverpaperindex == 0)
	{
	    iTot = iTot + ((((((numberofpages+4)/16)*350)+(((((numberofpages+4)/16)*((quantity)*1)+125)/1000)*(insidepagespaper*200))+(((((numberofpages+4)/16)*((500)*1)+125)/1000)*200))*turnaround)+(50+(.1*500))+((quantity/250)*25)+((((numberofpages+4)/4)*12)))*.9+proof+(quantity*binding)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 251 && quantity <= 1000 && coverpaperindex == 0)
	{
	    iTot = iTot + ((((((numberofpages+4)/16)*350)+(((((numberofpages+4)/16)*((quantity)*1)+125)/1000)*(insidepagespaper*200))+(((((numberofpages+4)/16)*((quantity)*1)+125)/1000)*200))*turnaround)+(50+(.1*quantity))+((quantity/250)*25)+((((numberofpages+4)/4)*12)))*.9+proof+(quantity*binding)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1001 && quantity <= 3000 && coverpaperindex == 0)
	{
	    iTot = iTot + ((((((numberofpages+4)/16)*250)+(((((numberofpages+4)/16)*((quantity)*1)+250)/1000)*(insidepagespaper*200))+(((((numberofpages+4)/16)*((quantity)*1)+250)/1000)*200))*turnaround)+(50+(.1*quantity))+((quantity/250)*7.5)+((((numberofpages+4)/4)*12)))+proof+(quantity*binding*.8)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 3001 && coverpaperindex == 0)
	{
	    iTot = iTot + ((((((numberofpages+4)/16)*250)+(((((numberofpages+4)/16)*((quantity)*1)+250)/1000)*(insidepagespaper*175))+(((((numberofpages+4)/16)*((quantity)*1)+250)/1000)*175))*turnaround)+(50+(.1*quantity))+((quantity/250)*5)+((((numberofpages+4)/4)*12)))+proof+(quantity*binding*.7)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 0 && quantity <= 250 && (coverpaperindex == 2 || coverpaperindex == 1))
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+125)/1000)*coverpaper)*100)+((((((500)*1)+125)/1000)*coverpaper)*100)+((numberofpages/16)*350)+((((numberofpages/16)*(((500)*1)+125))/1000)*insidepagespaper*200))+((((numberofpages/16)*(((quantity)*1)+125))/1000)*200))*turnaround)+(50+(.1*500))+((quantity/250)*25)+(((numberofpages/4)*12)+(coverpaper*25))*.9)+proof+(quantity*binding)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 251 && quantity <= 1000 && (coverpaperindex == 2 || coverpaperindex == 1))
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+125)/1000)*coverpaper)*100)+((((((quantity)*1)+125)/1000)*coverpaper)*100)+((numberofpages/16)*350)+((((numberofpages/16)*(((quantity)*1)+125))/1000)*insidepagespaper*200))+((((numberofpages/16)*(((quantity)*1)+125))/1000)*200))*turnaround)+(50+(.1*quantity))+((quantity/250)*25)+(((numberofpages/4)*12)+(coverpaper*25))*.9)+proof+(quantity*binding)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1001 && quantity <= 3000 && (coverpaperindex == 2 || coverpaperindex == 1))
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+250)/1000)*coverpaper)*100)+((((((quantity)*1)+250)/1000)*coverpaper)*100)+((numberofpages/16)*250)+((((numberofpages/16)*(((quantity)*1)+250))/1000)*insidepagespaper*200))+((((numberofpages/16)*(((quantity)*1)+250))/1000)*200))*turnaround)+(50+(.1*quantity))+((quantity/250)*7.5)+(((numberofpages/4)*12)+(coverpaper*25)))+proof+(quantity*binding*.8)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 3001 && (coverpaperindex == 2 || coverpaperindex == 1))
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+250)/1000)*coverpaper)*100)+((((((quantity)*1)+250)/1000)*coverpaper)*100)+((numberofpages/16)*250)+((((numberofpages/16)*(((quantity)*1)+250))/1000)*insidepagespaper*175))+((((numberofpages/16)*(((quantity)*1)+250))/1000)*175))*turnaround)+(50+(.1*quantity))+((quantity/250)*5)+(((numberofpages/4)*12)+(coverpaper*25)))+proof+(quantity*binding*.7)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 0 && quantity <= 250 && coverpaperindex == 3)
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+125)/1000)*coverpaper)*50)+((((((500)*1)+125)/1000)*coverpaper)*100)+((numberofpages/16)*350)+((((numberofpages/16)*(((500)*1)+125))/1000)*insidepagespaper*200))+((((numberofpages/16)*(((quantity)*1)+125))/1000)*200))*turnaround)+(50+(.1*500))+((quantity/250)*25)+(((numberofpages/4)*12)+(25))*.9)+proof+(quantity*binding)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 251 && quantity <= 1000 && coverpaperindex == 3)
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+125)/1000)*coverpaper)*50)+((((((quantity)*1)+125)/1000)*coverpaper)*100)+((numberofpages/16)*350)+((((numberofpages/16)*(((quantity)*1)+125))/1000)*insidepagespaper*200))+((((numberofpages/16)*(((quantity)*1)+125))/1000)*200))*turnaround)+(50+(.1*quantity))+((quantity/250)*25)+(((numberofpages/4)*12)+(25))*.9)+proof+(quantity*binding)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1001 && quantity <= 3000 && coverpaperindex == 3)
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+250)/1000)*coverpaper)*50)+((((((quantity)*1)+250)/1000)*coverpaper)*100)+((numberofpages/16)*250)+((((numberofpages/16)*(((quantity)*1)+250))/1000)*insidepagespaper*200))+((((numberofpages/16)*(((quantity)*1)+250))/1000)*200))*turnaround)+(50+(.1*quantity))+((quantity/250)*7.5)+(((numberofpages/4)*12)+(25)))+proof+(quantity*binding*.8)
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 3001 && coverpaperindex == 3)
	{
	    iTot = iTot + ((((coverpaper*100)+((((((quantity)*1+250)/1000)*coverpaper)*50)+((((((quantity)*1)+250)/1000)*coverpaper)*100)+((numberofpages/16)*250)+((((numberofpages/16)*(((quantity)*1)+250))/1000)*insidepagespaper*175))+((((numberofpages/16)*(((quantity)*1)+250))/1000)*175))*turnaround)+(50+(.1*quantity))+((quantity/250)*5)+(((numberofpages/4)*12)+(25)))+proof+(quantity*binding*.7)
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/multipagecatalogs.php" method="post">
                    ...
                    <table width="210" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Number of Pages: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('pagesexp','','show')" onMouseOut="MM_showHideLayers('pagesexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="numberofpages" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 7 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Cover Paper: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('coverpaperexp','','show')" onMouseOut="MM_showHideLayers('coverpaperexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="coverpaper" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 8 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Inside Pages Paper: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('insidepaperexp','','show')" onMouseOut="MM_showHideLayers('insidepaperexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="insidepagespaper" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 5 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Binding: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('bindingexp','','show')" onMouseOut="MM_showHideLayers('bindingexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="binding" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 10 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><span class="style25">Turnaround Time : <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('turnaroundexp','','show')" onMouseOut="MM_showHideLayers('turnaroundexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
...
?>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#B9B9B9"><span class="style25">Proof: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('proofexp','','show')" onMouseOut="MM_showHideLayers('proofexp','','hide')"></span></td>
