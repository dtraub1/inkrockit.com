...
<table width="803" border="0" align="center" cellpadding="14" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td><table width="774" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="317" height="306" align="right" valign="top" ><a name="top"></a><img src="images/index_new/IRlogo_top2.jpg" name="clickhere" width="317" height="76" border="0" id="clickhere"><br>
          <img src="images/index_new/IRlogo_bottom2.jpg" width="317" height="230" border="0" usemap="#Map2"></td>
        <td width="457" height="306" align="left" valign="top" class="style1" style="background-position:top; background-repeat:no-repeat;"><img src="images/index_new/astronaut3.jpg" width="457" height="306" border="0" usemap="#Map"></td>
      </tr>
    </table>
      <map name="Map">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="252" valign="top" bgcolor="#002D51"><table width="93%" border="0" cellpadding="0" cellspacing="0" bgcolor="1a6fab">
          <tr>
            <td colspan="2" bgcolor="#FFFFFF"><img src="images/topleft.gif" width="252" height="9"></td>
          </tr>
          <tr>
            <td colspan="2" align="center" bgcolor="#08294C"><!--
Skype 'Skype Me�!' button
http://www.skype.com/go/skypebuttons
--><script type="text/javascript" src="http://download.skype.com/share/skypebuttons/js/skypeCheck.js"></script><img src="images/cc_panel.jpg" alt="" width="229" height="76" align="texttop"></td>
          </tr>
          <tr>
            <td colspan="2" align="center" bgcolor="#0D2645"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="072e52">
              <tr>
                <td align="left" valign="middle" bgcolor="#0B294A"><p class="style18"><img src="images/adobe_icon_selected.jpg" alt="" width="59" height="35" border="0" align="absmiddle">&nbsp;9 x 12 Pocket Folder<br>
                  <a href="6x9_folders.php" class="style1"><img src="images/adobe_icon.jpg" alt="" width="59" height="35" border="0" align="absmiddle"></a><a href="6x9_folders.php">&nbsp;6 x 9 Pocket Folder<br>
                  </a><a href="4x9_folders.php" class="style1"><img src="images/adobe_icon.jpg" alt="" width="59" height="35" border="0" align="absmiddle"></a> <a href="4x9_folders.php" class="style18">4 x 9 Pocket Folder<br>
...
<p><img src="images/index_new/crisistop.gif" alt="" width="251" height="22"></p></td>
              ...
              <tr>
                <td width="251" bgcolor="#0B294A"><div class="style2" style="margin-left:23px; margin-right:23px; padding-top:10px;">
  ...
  <p class="style2"><span class="style23"><a href="custom_folders.html" title="Custom Pocket Folders" target="ink_dreams/custom_folders.html">Custom Folders <br>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="503" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="227" height="317" valign="top" background="images/index_new/main-customprintedpocketfolders.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="8%">&nbsp;</td>
                      <td width="92%" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="75" valign="top"><p class="style15"><span class="style14"><img src="images/new/orangearrow.jpg" width="14" height="13"> Full  Color<br>
                                  <img src="images/new/orangearrow.jpg" width="14" height="13"> <span class="style37">FREE</span> <span class="style35">Gloss <br>
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aqueous Coating</span>                                  </span><span class="style14"><br>
                                      ...
                                      <img src="images/new/orangearrow.jpg" width="14" height="13"> <span class="style31"><span class="style37">FREE CD / DVD &amp; BC Slits</span></span><br>
                                      <br>
                                  </span></p>                              </td>
                          </tr>
                          <tr>
                ...
                <td width="276" height="317" valign="top" background="images/index_new/main-customprintedpocketfolders2a.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                      <td width="92">&nbsp;</td>
                      <td width="92">&nbsp;</td>
                    ...
                    <tr valign="top">
                      <td colspan="4"><p class="style14"><img src="images/new/orangearrow.jpg" width="14" height="13"><a href="#custom_die_line"> Add a custom die-cut for only 18� a folder* </a></p></td>
                      </tr>
                </table></td>
              </tr>
            </table></td>
            ...
            <td width="446"><table width="492" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="446" align="center" valign="top"><h2><strong>POCKET FOLDER (9&quot; x 12&quot;)</strong></h2>
                  <p><span class="style7"><a href="javascript:requestSamples();"><img src="images/new/orangearrow.jpg" alt="" width="14" height="13" border="0" align="baseline">See, feel and touch the InkRockit Quality Difference!</a></span><span class="style7"><a href="http://www.katieharman.com/kh2.swf"><img src="images/folder_sample2.jpg" width="480" height="328" border="0"></a></span><span class="style31">Add <strong>just $350.00</strong> to print behind the pockets as shown above.</span></p>
...
<p><img src="images/9x12 folder.jpg" width="400" height="410"></p>
                  <p><span class="style48"><span class="style35">with Free Business Card &amp; CD Slits</span></span><span class="style7"><br>
                  </span></p>                  
                  ...
                  <table width="445" border="0" cellpadding="0" cellspacing="0" background="images/index_new/grid.gif" style="background-position:top; background-repeat:no-repeat;">
                    ...
                    <tr>
                      ...
                      <td height="35" class="style8"><div align="right" class="style21">495.00</div></td>
                      <td height="35" class="style8"><div align="right" class="style21">592.00</div></td>
                      <td height="35" class="style8"><div align="right" class="style21">774.00</div></td>
                      <td height="35" class="style8"><div align="right" class="style21">999.00</div></td>
                      <td class="style8">&nbsp;</td>
                    </tr>
                  </table>
                  <h5><strong><span class="style38"><a href="http://www.inkrockit.com/templates/PF_9x12.zip"><img src="images/new/download_zip.jpg" alt="Download Pocket Folder Template" width="37" height="37" border="0" /></a></span></strong><strong><a href="http://www.inkrockit.com/templates/PF_9x12.zip"><span class="style38"><br>
                  ...
                  <table width="445" border="0" cellpadding="0" cellspacing="0" background="images/index_new/grid.gif" style="background-position:top; background-repeat:no-repeat;">
                    ...
                    <tr>
                      <td height="50"><div align="right" class="style9">SubTotal:<br>
                        Tax:<br>
                        Shipping:</div></td>
                      <td height="50" class="style8"><div align="right">$ 319.00<br>
                        N/A<br>
                        23.00</div></td>
                      <td height="50" class="style8"><div align="right">$ 479.00<br>
                        N/A<br>
                        35.00</div></td>
                    ...
                    <tr>
                      <td height="35"><div align="right" class="style9">TOTAL:</div></td>
                      <td height="35" class="style8"><div align="right">342.00</div></td>
                      <td height="35" class="style8"><div align="right">514.00</div></td>
                  ...
                  <p align="center" class="style35"><a href="/upload"><strong><img src="/images/upload.jpg" alt="Upload Icon" width="37" height="37" border="0" /><br>
                    UPLOAD YOUR FINISHED FILE!</strong></a> </p>
<h1 class="style50"><a name="upgrades" id="upgrades"></a><img src="images/index_new/graybar.gif" width="442" height="25"></h1>
                  <blockquote>
