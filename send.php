...
//	$headers .= "From: InkRockit <dtraub@inkrockit.com>\r\n";
    ...
    if (mail("leads@imageteam.com", "InkRockit Printed Samples Request", $message, $headers)) {
        ...
        mail("vlodkow@gmail.com", "InkRockit Printed Samples Request", $message, $headers);
        ?>
        ...
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td valign="middle" align="center">
                    ...
                    <font face="Verdana" color="#00000" style="font-size:9pt;font-weight:bolder;">There has been an error<br> sending your information.<br><br>
                        Please close this window and retry.<br> If the problem persists contact:<br><a href="mailto:leads@inkrockit.com">leads@inkrockit.com</a></font><br><br>
