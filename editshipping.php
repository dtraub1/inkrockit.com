    ...
    <td><table width="841" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="841" height="467" border="0" cellpadding="0" cellspacing="0" bgcolor="#002A72">
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/inner/step1-fade.jpg" width="179" height="51"><br>
              <img src="images/inner/Step2-summary.jpg" width="179" height="105"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="posters.htm" class="style1">Posters</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="rackcards.htm" class="style1">Rack Cards</a> </span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="businesscards.htm" class="style1">Business Cards</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="letterhead.htm" class="style1">Letterhead</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="envelopes.htm" class="style1">Envelopes</a></span></td>
                </tr>
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="postcards.htm" class="style1">Post Cards</a></span></td>
                </tr>
              </table>
              <!-- InstanceEndEditable -->
            ...
            <td height="467" valign="top" background="images/inner/bluevertline-wide.jpg" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="MainBody" -->
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="503" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
						<td colspan="2" height="42"><img src="images/inner/customersupport.jpg" width="503" height="42"></td>
                      </tr>
                      <tr>
                ...
                <?
                    ...
                    $Query2 = "SELECT * FROM address_book WHERE address_book_id = " . $ID . " AND addresstype = 'S' AND customers_id = " . $_SESSION['customers_id'];
                ...
                ?>
							<form name="form1" method="post" action="editshipping2.php">
							<input type="hidden" name="ID" value="<?print($ID);?>">
							<table width="95%"  border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="14" height="26"><img src="images/inner/login-orangecorner.jpg" width="14" height="26"></td>
								<td height="26" bgcolor="#FF6100"><span class="style29">EDIT SHIPPING </span></td>
								<td width="14" height="26"><img src="images/inner/login-orangecorner-right.jpg" width="14" height="26"></td>
							  </tr>
							  <tr>
								<td width="14" background="images/inner/login-leftgrayline.jpg">&nbsp;</td>
								<td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                                  <tr>
                                    <td colspan="2" class="style15">Shipping Address - <span class="style31">(<span class="style33">*</span>) Indicates Required Field</span></td>
                                    </tr>
                                  <tr>
                                    <td width="35%" class="style17">Address Identifier <span class="style15"><span class="style31"><span class="style33">*</span></span></span><br>
                                      (ex: Home, Work) </td>
                                    <td width="65%"><input name="Shipping_Identifier" value="<?print($addidentifier);?>" type="text" id="addidentifier" size="30" maxlength="50"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">Company</td>
                                    <td width="65%"><input name="entry_company" value="<?print($company);?>" type="text" id="entry_company" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">First Name <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_First_Name" value="<?print($firstname);?>" type="text" id="entry_firstname" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">Last Name <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_Last_Name" value="<?print($lastname);?>" type="text" id="entry_lastname" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">Street Address <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_Street_Address" value="<?print($street_address);?>" type="text" id="entry_street_address" size="30" maxlength="64"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">City <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_City" value="<?print($city);?>" type="text" id="entry_city" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">State / Province <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Shipping_State" value="<?print($state);?>" type="text" id="entry_state" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Postal Code <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Shipping_Postal_Code" value="<?print($postcode);?>" type="text" id="entry_postcode" size="10" maxlength="10"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Country <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><select name="entry_country_id" id="entry_country_id">
								  <?
								     ...
								     if ($myrow = mysql_fetch_array($queryexe)) {
								       do {
								  ?>
                                        <option value="<? print($myrow[countries_id]); ?>" <? if ($myrow[countries_id]==223) { ?>selected<?}?>><? print($myrow[countries_name]); ?></option>
								  <?
								...
								<td width="14" background="images/inner/login-rightgrayline.jpg">&nbsp;</td>
							  </tr>
							  <tr>
								<td width="14" background="images/inner/login-leftgrayline.jpg">&nbsp;</td>
								<td><div align="center">
								      <input name="Submit" type="submit" onClick="MM_validateForm('customers_firstname','','R','customers_lastname','','R','customers_email_address','','RisEmail','customers_telephone','','R','addidentifier','','R','entry_firstname','','R','entry_lastname','','R','entry_street_address','','R','entry_city','','R','entry_state','','R','entry_postcode','','R','bill_addidentifier','','R','bill_entry_firstname','','R','bill_entry_lastname','','R','bill_entry_street_address','','R','bill_entry_city','','R','bill_entry_state','','R','bill_entry_postcode','','R','payment_identifier','','R','cctype','','R','ccnumber','','R','ccexpdate','','R','ccseccode','','R','nameoncard','','R','customers_password','','R','customers_password2','','R');return document.MM_returnValue" value="Edit Shipping">
								    &nbsp;&nbsp;&nbsp;
								      <input name="Submit" type="submit" onClick="MM_validateForm('customers_firstname','','R','customers_lastname','','R','customers_email_address','','RisEmail','customers_telephone','','R','addidentifier','','R','entry_firstname','','R','entry_lastname','','R','entry_street_address','','R','entry_city','','R','entry_state','','R','entry_postcode','','R','bill_addidentifier','','R','bill_entry_firstname','','R','bill_entry_lastname','','R','bill_entry_street_address','','R','bill_entry_city','','R','bill_entry_state','','R','bill_entry_postcode','','R','payment_identifier','','R','cctype','','R','ccnumber','','R','ccexpdate','','R','ccseccode','','R','nameoncard','','R','customers_password','','R','customers_password2','','R');return document.MM_returnValue" value="Delete Shipping">
								  </div></td>
								<td width="14" background="images/inner/login-rightgrayline.jpg">&nbsp;</td>
							  </tr>
							  <tr>
								<td height="10"><img src="images/inner/login-leftgraycorner.jpg" width="14" height="10"></td>
								<td height="10" background="images/inner/login-bottomgrayline.jpg"><img src="images/spacer.gif" width="1" height="10"></td>
								<td height="10"><img src="images/inner/login-rightgraycorner.jpg" width="14" height="10"></td>
							  </tr>
							</table>
							</form>
							<br><br>
							<table width="90%"  border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="14">&nbsp;</td>
								<td><p class="style17"><a href="editaddress.php"><img src="images/inner/back.jpg" width="68" height="25" border="0"></a></p>
								  <p class="style17">PRIVACY PROTECTION POLICY: The privacy and security of the information you provide is a priority at InkRockit. All personal information is kept on secured servers and will be used only for purposes relating to your transactions on this website. No information will be provided to outside sources or used for marketing or promotional purposes.<br>
								      <br>
								  </p></td>
								<td width="14">&nbsp;</td>
							  </tr>
