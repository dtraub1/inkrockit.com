...
<?
  ...
  // split apart the hash / salt
	...
	$Query = "SELECT customers_id, customers_password FROM customers WHERE customers_email_address = '" . $email . "'";
	$queryexe = mysql_query($Query);
	if ($myrow = mysql_fetch_array($queryexe)) {
	  $customers_id = $myrow[customers_id];
	  $customers_password = $myrow[customers_password];
	} else {
	  $customers_id = 'NONE';
	}

	if (!tep_validate_password($password, $customers_password)) {
	  $customers_id = 'NONE';
    }

    if ($customers_id == 'NONE') {
?>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="503" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
						<td colspan="2" height="42"><img src="images/inner/customerlogin.jpg" width="503" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="484">
						<br><br><span class="style17">I'm sorry, but that login is incorrect<br><br>
						<a href="login.php"><font color="#000000">Retry Login</font></a></span>
						</td>
                      </tr>
                  </table></td>
                </tr>
