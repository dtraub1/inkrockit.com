...
//    }
    ...
    if ($_nThisItemIndex == -1) {
      ...
      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 17 and pa.products_id = $_sItemNo AND pa.options_values_price = $envelopesize";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemEnvelopesize[] = $myrow['products_options_values_name'];
...
<div id="paperexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select premium white paper or standard white paper, two great paper options that are compatible with laser and ink jet printers.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="envelopesizeexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'><li>The A-7 size fits a 7 x 10 folded notecard.
<li>The A-6 size fits a flat 4 x 6 card, or is a good remittence size thats fits in the A-7.
<li>The Number 10 is the standard business envelope.
<li>The Number 9 is the remittence envelope that fits into the Number 10.<ul/><ul></ul></TD></TR></TABLE></td></tr></table></div>
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Envelopes</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="2"><img src="images/inner/envelopes.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><img src="images/inner/envelopespict.jpg" width="274" height="125"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
...
&nbsp; </td>
                            ...
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Printed on standard or premium white envelopes <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Available in four sizes: A-6, A-7, <br>
                                No. 9 and No. 10 <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Proofs available <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Optional: letterhead available to <br>
                                match envelopes <br>
&nbsp; </td>
                            </tr>
                        </table></td>
                      ...
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274" class="style16"><STRONG>Custom printed envelopes</STRONG> offer you the opportunity to customize the presentation of your logo, company name and address for clients and customers. Envelopes are printed on one side with your choice of standard or premium paper. You also have the opportunity to select a number of different envelope sizes available.</td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
...
<!--
	...
	var envelopesize = parseFloat(document.forms["cart_quantity"].elements["envelopesize"].value);
	...
	{
	    iTot = iTot + ((275)*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 500 && quantity <= 1000 && paper==2)
	{
	    iTot = iTot + ((350)*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1000 && paper==2)
	{
	    iTot = iTot + ((350+(100*((quantity/1000)-1)))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 0 && quantity <= 500 && paper==1)
	{
	    iTot = iTot + ((190)*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 500 && quantity <= 1000 && paper==1)
	{
	    iTot = iTot + ((220)*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 1000 && paper==1)
	{
	    iTot = iTot + ((220+(50*((quantity/1000)-1)))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/envelopes.php" method="post">
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Envelope Size: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('envelopesizeexp','','show')" onMouseOut="MM_showHideLayers('envelopesizeexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="envelopesize" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 17 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#B9B9B9"><span class="style25">Proof: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('proofsexp','','show')" onMouseOut="MM_showHideLayers('proofsexp','','hide')"></span></td>
