...
$project = "";
uploadFile("$project", $HTTP_POST_FILES['upload']['tmp_name'], $jobnumber."-".$HTTP_POST_FILES['upload']['name']);
  ...
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td width="32%"><span class="style53">File Upload</span></td>
          <td width="68%">&nbsp;</td>
        </tr>
        <tr>
          <td><div align="right"></div></td>
          <td class="style55">Your file has been uploaded.</td>
        </tr>
      </table>
