...
<title>The 4 x 9 Pocket Folder Printing Experts</title>
...
body table tr td table tr td table tr td table tr td h1 {
	color: #000;
}
-->
</style>
        ...
        <td width="252" valign="top" bgcolor="#002D51"><table width="93%" border="0" cellpadding="0" cellspacing="0" bgcolor="1a6fab">
          ...
          <tr>
            <td colspan="2" align="center" bgcolor="#0D2645"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="072e52">
              <tr>
                <td align="left" valign="middle" bgcolor="#0B294A"><p class="style18"><a href="9x12_folders.php"><img src="images/adobe_icon.jpg" alt="" width="59" height="35" border="0" align="absmiddle"></a>&nbsp;<a href="9x12_folders.php">9 x 12 Pocket Folder</a><br>
                  <a href="6x9_folders.php" class="style1"><img src="images/adobe_icon.jpg" alt="" width="59" height="35" border="0" align="absmiddle">&nbsp;6 x 9 Pocket Folder<br>
                  </a><img src="images/adobe_icon_selected.jpg" alt="" width="59" height="35" border="0" align="absmiddle"> 4 x 9 Pocket Folder<br>
                  <span class="style28"><a href="legal_size_folder.php" class="style1"><img src="images/adobe_icon.jpg" alt="" width="59" height="35" border="0" align="absmiddle"></a></span> <a href="legal_size_folder.php" class="style18"></a><a href="legal_size_folder.php" class="style18">9 x 14.5 Legal Folder</a><br>
...
<p><img src="images/index_new/crisistop.gif" alt="" width="251" height="22"></p></td>
  ...
  <p class="style2"><span class="style23"><a href="custom_folders.html">Custom Folders <br>
...
anywhere else again!</span></p>
              <p class="style2"><strong><span class="style6">Products</span><br>
                  ...
                  <a href="folders.php">Pocket Folders</a><br>
...
Custom Orders</strong></p>
        ...
        <td width="534" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="446"><table width="492" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="4" background="images/index_new/priceleft.gif"><p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p></td>
                <td width="472" align="center" valign="top"><h1><a href="javascript:requestSamples();"><span class="style39"></span></a><a href="javascript:requestSamples();"><span class="style39"></span></a>Mini Pocket Folder 4&quot; x 9&quot;<img src="images/4x9_sample.jpg" width="454" height="504" alt="6x9 folder"><span class="style7"><br>
                  <br>
                </span><span class="style46"><span class="style43">with Free Business Card &amp; CD Slits</span></span><span class="style7"><br>
                      <span class="style28"><span class="style48">Full Color (4-color front, back &amp; inside pockets), <br>
                      with 1 or 2 pockets</span></span></span></h1>
...
<table width="445" border="0" cellpadding="0" cellspacing="0" background="images/index_new/grid.gif" style="background-position:top; background-repeat:no-repeat;">
  ...
  <tr>
    ...
    <td height="50" class="style8"><div align="right">$ 554.00<br>
      N/A<br>
      63.00</div></td>
    <td height="50" class="style8"><div align="right">$ 719.00<br>
      N/A<br>
      79.00</div></td>
    <td class="style8">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td height="35" class="style8"><div align="right">617.00</div></td>
    <td height="35" class="style8"><div align="right">798.00</div></td>
    <td class="style8">&nbsp;</td>
  </tr>
</table>
<h5 align="center"><strong><a href="http://www.inkrockit.com/templates/PF_4x9.zip" class="style28"><span class="style38"><img src="images/new/download_zip.jpg" alt="Download Pocket Folder Template" width="37" height="37" border="0" /><br>
...
</span><span class="style48">4&quot; X 9&quot;</span><span class="style38"> POCKET FOLDER TEMPLATE</span></a></strong></h5>
                  <h5 align="center" class="style38"><a href="/upload"><strong><img src="/images/upload.jpg" alt="Upload Icon" width="75" height="75" border="0" align="absmiddle" /></strong></a><strong>&nbsp;&nbsp;&nbsp;</strong><a href="/upload"><strong>UPLOAD YOUR FINISHED FILE!</strong></a></h5>
<h1 class="style50"><a name="upgrades" id="upgrades"></a><img src="images/index_new/graybar.gif" width="442" height="25"></h1>
                ...
                <td width="16" background="images/index_new/priceright.gif">&nbsp;&nbsp;&nbsp;
