...
<head>
  ...
  <link rel="stylesheet" href="sample_pack.css">
</head>
<script>
  function checkForm() {
...
<form method="POST" id="request" onSubmit="return checkForm();" action="//inkrockit.com/request/send.php">
        ...
        <div class="right_block_sample_pack right">
          ...
          <table class="form_adress_sample_pack">
            ...
            <tr>
              ...
              <td>
                <div style="" class="one_form_input">
                  <input type="text" title="Address" class="input_box_ship" name="street" placeholder="* No P.O. Box deliveries">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <div style="" class="one_form_input">
                  <input name="zip" id="zip" type="text" title="Zip Code" class="small_input input_box_ship">
                </div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div class="one_form_input">
                  <input name="phone" id="phone" type="text" autocomplete="off" class="small_input input_box_ship left" title="Phone Number">
                  <div class="right">
                    <span class="left" style="margin-top: 4px; width: 25px; padding-left: 15px">Ext</span>
            ...
            <tr>
              ...
              <td>
                <div style="" class="one_form_input">
                  <input name="email" type="email" class="input_box_ship" name="company" title="E-mail">
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                ...
                <table class="marg_t10" width="100%" style="line-height: 20px">
                  <tr>
                    <td width="50%">
                      <input name="folders" type="checkbox" value="Folders"><span class="checkboxtext">Folders</span>
                    </td>
                    <td>
                      <input name="buscards" type="checkbox" value="Business Cards"><span class="checkboxtext">Business Cards</span>
                    </td>
                  </tr>
                  <tr>
                    <td width="50%">
                  ...
                  <tr>
                    <td width="50%">
                      <input name="media" type="checkbox" value="Media/Press Kits"><span class="checkboxtext">Media/Press Kits</span>
                    </td>
                    <td>
                      <input name="directmail" type="checkbox" value="Direct Mail"><span class="checkboxtext">Direct Mail</span>
                    </td>
                  </tr>
                  <tr>
                    <td width="50%">
                    ...
                    <td>
                      <input name="other" type="checkbox" value="Other"><span class="checkboxtext">Other</span>
                      <input name="othertext" type="text" id="othertext" class="right" style="width: 76px">
                    </td>
                  </tr>
                  <tr>
                    <td width="50%">
                      <input name="photoframe" readonly="true" checked="checked" type="checkbox" value="Photo Frame" onclick="return false;"><span
                          class="checkboxtext">Photo Frame</span>
                    </td>
                    <td>
                    </td>
                  </tr>
...
<!--           src="http://www.googleadservices.com/pagead/conversion/1071175607/?value=0&amp;label=3SG_COfqhgQQt6_j_gM&amp;guid=ON&amp;script=0"/>-->
<!--    </div>-->
<!--  </noscript>-->
