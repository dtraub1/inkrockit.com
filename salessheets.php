...
<div id="turnaroundexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'><li>Your can choose to have the job shipped in 1, 2, 3, 5 or 10 business days.
<li>Business days are Monday through Friday. We are closed Holidays, Saturdays and Sundays for production.
<li>We start counting toward the ship date when your order is placed and your files are uploaded and attached to the order before 5pm Pacific Standard Time.</ul>
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Sales Sheets</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="3"><img src="images/inner/salessheets.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274">                          <p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px"><img src="images/inner/salessheetspict.jpg" width="274" height="172"></SPAN></FONT></p>
                          <table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Full-color front with full-color, B/W or blank back <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Four papers: 70lb. matte text, 80lb. matte cover, 100lb. gloss text, and 100lb. gloss cover <br>
&nbsp;</td>
                            </tr>
                          </table>
                          <p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px">Sales Sheets are the standard for presenting quick overviews of your company&rsquo;s products and services. They <br>
                            are excellent for trade shows, mailing <br>
                            or for retail/wholesale distribution.</SPAN></FONT></p></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274">&nbsp;</td>
...
<!--
	...
	{
	    iTot = iTot + (((((.71+paper)*quantity*colors)+10)+((20*holedrilling)+(holedrilling*((quantity/1000)*20)))+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 500 && colors == 1)
	{
	    iTot = iTot + (((25+150*colors)+(quantity*.04)+((.5*quantity)*paper)+((20*holedrilling)+(holedrilling*((quantity/1000)*20)))+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 500 && colors != 1)
	{
	    iTot = iTot + (((25+150*colors)+(quantity*.08)+((.5*quantity)*paper)+((20*holedrilling)+(holedrilling*((quantity/1000)*20)))+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/salessheets.php" method="post">
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Hole Drilling: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('drillingexp','','show')" onMouseOut="MM_showHideLayers('drillingexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
