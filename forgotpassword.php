                ...
                <tr>
                  <td valign="top"><table width="503" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      ...
                      <tr>
						...
						<form name="password_forgotten" action="forgotpassword2.php" method="post"><table border="0" width="100%" cellspacing="0" cellpadding="0">
							  <tr>
								...
								<td><table border="0" width="100%" height="100%" cellspacing="1" cellpadding="2" class="infoBox">
								  <tr class="infoBoxContents">
									<td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
									  ...
									  <tr>
										<td class="style16" colspan="2">If you've forgotten your password, enter your e-mail address below and we'll send you an e-mail message containing your new password.</td>
									  </tr>
									  <tr>
										<td><img src="images/pixel_trans.gif" border="0" alt="" width="100%" height="10"></td>
									  </tr>
									  <tr>
										<td class="main"><b class="style15">E-Mail Address:</b> <input type="text" name="email_address"></td>
									  </tr>
									  <tr>
										<td><img src="images/pixel_trans.gif" border="0" alt="" width="100%" height="10"></td>
									  </tr>
								  ...
								  <tr class="infoBoxContents">
									<td><table border="0" width="100%" cellspacing="0" cellpadding="2">
									  <tr>
										...
										<td><a href="login.php"><img src="images/button_back.gif" border="0" alt="Back" title=" Back " width="100" height="22"></a></td>
										<td align="right"><input type="image" src="images/button_continue.gif" border="0" alt="Continue" title=" Continue "></td>
										<td width="10"><img src="images/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
									  </tr>
									</table></td>
								  </tr>
