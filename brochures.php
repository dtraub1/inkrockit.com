...
//    }
    ...
    if ($_nThisItemIndex == -1) {
      ...
      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 18 and pa.products_id = $_sItemNo AND pa.options_values_price = $paperfold";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemPaperfold[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 11 and pa.products_id = $_sItemNo AND pa.options_values_price = $holedrilling";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemHoledrilling[] = $myrow['products_options_values_name'];
...
<div id="colorsexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>You can choose one of three ways to print your product:<ul>
<li>Full color on BOTH inside and outside.
<li>Full color on the outside, black and white on the inside.
<li>Full color on the outside, no printing on the inside (Blank).
</ul><ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="paperexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Choose from four available paper types: 70 lb. Matte Text, 80 lb. Matte Cover, 100 lb. Gloss Text and 100 lb. Gloss Cover.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="paperfoldexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'><table width="100" border="0" cellspacing="0" cellpadding="4">
  <tr align="center" valign="bottom">
    <td class="style16" nowrap><img src="/images/inner/halffold.gif" width="64" height="139" vspace="1"><br>
      Half Fold </td>
    <td class="style16" align="center" nowrap><img src="/images/inner/letterfold.gif" width="59" height="132" vspace="1"><br>
      Letter Fold <br>
    </td>
    <td class="style16" nowrap><img src="/images/inner/zfold.gif" width="58" height="147" vspace="1""><br>
      Z-Fold </td>
  </tr>
</table><ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="holedrillingexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Add 3/16", 5/16" or 1/4" holes for hang tags or for placing in three-ring binders. Holes will be drilled according to your placement of small (1/32 inch) dots in your artwork.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="perforationexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Perforation allows for clean tearing of the paper product across a straight line. To show us where to perforate, draw a dashed line (e.g., "----------") beside your artwork in the bleed margin or otherwise outside the print area. Note: Your product must be at least 3" x 4".<ul></ul></TD></TR></TABLE></td></tr></table></div>
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Brochures</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="3"><img src="images/inner/brochures.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="264"><p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px"><img src="images/inner/brochurespict.jpg" width="274" height="172"></SPAN></FONT></p>
                          <table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">8.5&quot; x 11&quot; standard-format brochure available in half fold, letter fold and <br>
                                z-fold formats<br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Full-color printing on front side with color or B/W back <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td class="style15">Four papers available: 100% <br>
                                recycled 70lb. matte text and 80lb. matte cover, 100lb. gloss cover and 100lb. gloss text <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td class="style15">Instant online ordering and digital <br>
                                file upload <br>
&nbsp; </td>
                            </tr>
                          </table>
                          <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td><font face="Verdana, Helvetica, Arial"><span style="FONT-SIZE: 12px">8 1/2 &rdquo;x11&rdquo; Brochures are perfect for placement into typical rack displays and for mailing in your company&rsquo;s standard (#10) business envelope. Tell your company&rsquo;s story in pictures and words as each panel unfolds. We offer a variety of choices in paper weights, grades, and finishes such as spot or flood varnishes as well as UV coating. &nbsp;Some of the paper options available are 80 or 100 pound text weight or 80 pound cover weight ... all coated two sides. </span></font></td>
                            </tr>
                          </table>                          <p>&nbsp;</p></td>
                      </tr>
                      <tr>
...
<!--
	...
	var paperfold = parseFloat(document.forms["cart_quantity"].elements["paperfold"].value);
	var holedrilling = parseFloat(document.forms["cart_quantity"].elements["holedrilling"].value);
	...
	{
	    iTot = iTot + (((50+(quantity*((paper/2)*1.5))+(150*colors)+(20+(quantity/1000)*20))+((20*holedrilling)+(holedrilling*((quantity/1000)*20)))+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 251 && quantity <= 500)
	{
	    iTot = iTot + (((75+(quantity*((paper/2)*1.25))+(150*colors)+(20+(quantity/1000)*20))+((20*holedrilling)+(holedrilling*((quantity/1000)*20)))+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}

	if (quantity > 500)
	{
	    iTot = iTot + (((100+quantity*(paper/2)+(150*colors)+(20+(quantity/1000)*20))+((20*holedrilling)+(20+(quantity/1000*20))+(holedrilling*((quantity/1000)*20)))+((20*perforation)+(perforation*((quantity/1000)*20))))*turnaround)+proof
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/brochures.php" method="post">
                    ...
                    <table width="210" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Colors: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('colorsexp','','show')" onMouseOut="MM_showHideLayers('colorsexp','','hide')"></span></td>
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Paper: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('paperexp','','show')" onMouseOut="MM_showHideLayers('paperexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Paper Fold: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('paperfoldexp','','show')" onMouseOut="MM_showHideLayers('paperfoldexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="paperfold" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 18 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Hole Drilling: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('holedrillingexp','','show')" onMouseOut="MM_showHideLayers('holedrillingexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="holedrilling" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 11 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td colspan="2"><table width="184" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td background="images/inner/calc2a.jpg"><div align="right"><span class="style27">TOTAL:&nbsp;</span></div></td>
                      ...
                      <tr>
                        <td colspan="2"><table width="184" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td background="images/inner/calc2a.jpg"><div align="right" class="style27">Each:&nbsp;</div></td>
