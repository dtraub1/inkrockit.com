          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td>&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU"><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/postcards.php" class="style1">Post Cards</a></span></td>
                </tr>
              </table>
              <!-- InstanceEndEditable -->
                ...
                <tr>
                  <td valign="top"><table width="503" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
					    ...
					    ?>
								  <td colspan="2" height="42"><img src="images/inner/shoppingcart.jpg" width="503" height="42"></td>
					    <?
							  }
							} else {
					    ?>
