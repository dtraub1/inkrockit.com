    ...
    <td>
      ...
      <div class="tr-wrap">
            <div class="tr-review-wrap">
              <a
                href="https://www.trustpilot.com/evaluate/www.inkrockit.com"
                class="tr-review"
                target="_blank"
              >
              ...
              <a
                href="https://www.trustpilot.com/review/www.inkrockit.com"
                class="trust-back"
                target="_blank"
              >
...
<p><img src="images/index_new/crisistop.gif" alt="" width="251" height="22"></p></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" class="style1"><span class="style57">Custom Is Our Standard.</span></td>
          </tr>
          <tr>
...
<p class="style38"><strong>TECH SPECS: 4/0, 12pt (100# C1S Cover)</strong></p>
              ...
              <ul>
                ...
                <li><span class="style38">PMS Colors</span><br>
                  <span class="style65">Add $150.00 for each additional PMS color for all listed quantitie (excluding metallic colors).<br>
                    Add $65.00 for each additional 1000</span></li>
                ...
                <li><span class="style38">Process 4-color inside </span><br>
