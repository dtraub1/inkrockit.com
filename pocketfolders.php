...
//    }
    ...
    if ($_nThisItemIndex == -1) {
      ...
      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 15 and pa.products_id = $_sItemNo AND pa.options_values_price = $slotorientation";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemSlotorientation[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 6 and pa.products_id = $_sItemNo AND pa.options_values_price = $coating";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemCoating[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 5 and pa.products_id = $_sItemNo AND pa.options_values_price = $paper";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemPaper[] = $myrow['products_options_values_name'];

      $Query = "SELECT pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 16 and pa.products_id = $_sItemNo AND pa.options_values_price = $businesscardslot";
      $queryexe = mysql_query($Query);
      $myrow = mysql_fetch_array($queryexe);
      $_sCartItemBusinesscardslot[] = $myrow['products_options_values_name'];
...
<div id="slotorientationexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Card slots may be included for either horizontal (3.5" x 2") or vertical (2" x 3.5") business card designs.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="coatingexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Your choice of gloss or satin aqueous coating is included.  The gloss coating gives a high contrast appearance while the satin gives a duller sheen and creates the impression of greater depth.<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="paperstockexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Choose from two paper stocks. 10 pt. C2S or 12 pt. C2S<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="businesscardslotexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Four slits centered on either or both flaps to fit a horizontal (3.5" x 2") or vertical (2" x 3.5") card can be added at no additional charge<ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="turnaroundexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'><li>Choose a ship date of 5 days or 10 days.

<li>Business days are Monday through Friday. We are closed Holidays, Saturdays and Sundays for production.

<li>We start counting toward the ship date when your order is placed and your files are uploaded and attached to the order before 5pm Pacific Standard Time.</ul><ul></ul></TD></TR></TABLE></td></tr></table></div>
<div id="proofexp" style="position:absolute; width:375; height:0; z-index:99; left: 100px; top:100px; overflow: visible; visibility: hidden"><table width=350 border=0 cellpadding=1 cellspacing=0 bgcolor=#041C43><tr><td><TABLE width=100% border=0 cellpadding=10 cellspacing=0><TR><TD bgcolor='white' class='style16'>Select a Standard Hardcopy Proof to proof your job:<br><font color=ff0000><b>*Note: The proofing process can/will delay the<br>              turnaround time of your job</b><br><br>
All proofs are sent to the billing address, unless told otherwise.</font>
<ul>
<li>Customers can request a Standard Hardcopy Proof on this product if you need an accurate color proof to assure a high quality job.  There will be an additional $70 charge for each additional proof.<br><br>
          ...
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/new/left-chooseyourproduct.jpg" width="179" height="123"><br>
              ...
              <table width="170" border="0" cellspacing="0" cellpadding="1">
                <tr>
                  <td valign="bottom">&nbsp;<img src="images/new/yellowtriangle.jpg" width="12" height="12"> <span class="style1noU">Pocket Folders</span></td>
                </tr>
                <tr>
              ...
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"><table width="293" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                      <tr>
                        <td colspan="2"><img src="images/inner/pocketfolders.jpg" width="293" height="42"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><p><img src="images/inner/pocketfolderpict.jpg" width="274" height="172"></p>
                          <p><FONT face="Verdana, Helvetica, Arial"><SPAN style="FONT-SIZE: 12px">Full color pocket folders offer an attractive way of packaging and distributing your company&rsquo;s marketing and promotional materials. Ample pockets accommodate any number of printed items like price sheets, sales sheets, photographs, samples and brochures and the business card slits allow them to be customized for individual representatives.<br>
&nbsp;                          </SPAN></FONT></p>
                          </td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><table width="274"  border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">9&quot; x 12&quot; Quality Pocket Folder <br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Process 4-color with two 4&quot; pockets <br>
&nbsp;</td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Business card slits on either or both pockets<br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">10pt. or 12pt. premium gloss cover stock with Aqueous coating<br>
&nbsp; </td>
                            </tr>
                            <tr valign="top">
                              <td width="14"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" class="style15">Custom pocket die cutting and options for holding CDs available<br>
&nbsp; </td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><span class="style16">Get noticed with high quality, custom designed pocket folders for your company or project. </span></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><img src="images/inner/horizblueline.jpg" width="272" height="24"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td width="274"><img src="images/inner/styleoptions.jpg" width="205" height="19"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td><table width="274" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="118" valign="top" class="style17">View images of folder options along with downloadable templates. </td>
                              <td width="156" valign="bottom"><img src="images/inner/styleoptionspict.jpg" width="156" height="56"></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td colspan="2"><img src="images/inner/styleoptionspict2.jpg" width="293" height="55"></td>
                      </tr>
                      <tr>
                        <td width="19">&nbsp;</td>
                        <td width="274"><img src="images/inner/relateditems.jpg" width="122" height="18"></td>
                      </tr>
                      <tr>
                        <td width="19">&nbsp;</td>
                        <td width="274" class="style16">Here are some items that you may also need to help support your marketing or promotional efforts. </td>
                      </tr>
                      <tr>
                        <td width="19">&nbsp;</td>
                        <td><table width="274" border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td width="14" height="25"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" height="25"><span class="style23"><u><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/multipagecatalogs.php" class="bodylink">Multipage Catalogs</a> </u></span></td>
                            </tr>
                            <tr valign="top">
                              <td width="14" height="25"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" height="25"><span class="style23"><u><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/salessheets.php" class="bodylink">Sales Sheets </a></u></span></td>
                            </tr>
                            <tr valign="top">
                              <td width="14" height="25"><img src="images/inner/orangearrow.jpg" width="10" height="14"></td>
                              <td width="260" height="25"><span class="style23"><u><a href="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/businesscards.php" class="bodylink">Business Cards </a></u></span></td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td colspan="2"><img src="images/inner/awardwinningdesign.jpg" width="293" height="31"></td>
                      </tr>
                      <tr>
                        <td width="19" background="images/inner/bluevertline.jpg">&nbsp;</td>
                        <td><table width="274" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="261" class="style16">No matter how big or small your project or business, you deserve a design solution that gets results. </td>
                              <td width="13" background="images/inner/bluevertline2.jpg">&nbsp;</td>
                            </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td colspan="2"><img src="images/inner/bottomgoline.jpg" width="293" height="48"></td>
                      </tr>
                  </table></td>
...
<!--
	...
	var slotorientation = parseFloat(document.forms["cart_quantity"].elements["slotorientation"].value);
	var paper = parseFloat(document.forms["cart_quantity"].elements["paper"].value);
	var coating = parseFloat(document.forms["cart_quantity"].elements["coating"].value);
	var businesscardslot = parseFloat(document.forms["cart_quantity"].elements["businesscardslot"].value);
	...
	{
	    iTot = iTot + .85*(842.7+((paper/1.178)*842.7)-((paper/1.2)*842.7))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 101 && quantity <= 250)
	{
	    iTot = iTot + .85*(963.82+((paper/0.982)*963.82)-((paper/1.2)*963.82))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 251 && quantity <= 500)
	{
	    iTot = iTot + .85*(1160.0+((paper/1.088)*1160.0)-((paper/1.2)*1160.0))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 501 && quantity <= 1000)
	{
	    iTot = iTot + .815*(1441.47+((paper/1.173)*1441.47)-((paper/1.2)*1441.47))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 1001 && quantity <= 2000)
	{
	    iTot = iTot + .85*(1859.41+((paper/1.113)*1859.41)-((paper/1.2)*1859.41))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 2001 && quantity <= 3000)
	{
	    iTot = iTot + .85*(2378.0+((paper/1.153)*2378.0)-((paper/1.2)*2378.0))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 3001 && quantity <= 4000)
	{
	    iTot = iTot + .85*(2499.12+((paper/1.065)*2499.12)-((paper/1.2)*2499.12))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 4001 && quantity <= 5000)
	{
	    iTot = iTot + .85*(2828.35+((paper/1.075)*2828.35)-((paper/1.2)*2828.35))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 5001 && quantity <= 7500)
	{
	    iTot = iTot + .85*(3589.18+((paper/1.147)*3589.18)-((paper/1.2)*3589.18))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}

	if (quantity >= 7501 && quantity <= 10000)
	{
	    iTot = iTot + .85*(4457.47+((paper/1.146)*4457.47)-((paper/1.2)*4457.47))*turnaround+(proof*2)+ coating;
		mTot = mTot + iTot / quantity;
	}
...
// -->
                  ...
                  <td width="210" valign="top" bgcolor="#FFFFFF"><form name="cart_quantity" action="https://ss41.shared.server-system.net/~imageteam.com/inkrockit.com/pocketfolders.php" method="post">
                    ...
                    <table width="210" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Slot Orientation: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('slotorientationexp','','show')" onMouseOut="MM_showHideLayers('slotorientationexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="slotorientation" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 15 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Paper: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('paperstockexp','','show')" onMouseOut="MM_showHideLayers('paperstockexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="paper" class="style17Copy" onChange="return calc_1(1);">
<?
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Coating: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('coatingexp','','show')" onMouseOut="MM_showHideLayers('coatingexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="coating" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 6 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
...
?>
                      ...
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" valign="top" bgcolor="#B9B9B9"><span class="style25">Business Card Slot: <img src="images/inner/questionmark.jpg" width="17" height="16" align="absbottom" onMouseOver="MM_showHideLayers('businesscardslotexp','','show')" onMouseOut="MM_showHideLayers('businesscardslotexp','','hide')"></span></td>
                        <td width="26" background="images/inner/grayright.jpg">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="17" background="images/inner/grayleft.jpg">&nbsp;</td>
                        <td width="167" bgcolor="#B9B9B9"><select name="businesscardslot" class="style17Copy" onChange="return calc_1(1);">
<?
  $Query = "SELECT pa.options_values_price, pov.products_options_values_name FROM products_attributes pa, products_options_values pov WHERE pa.options_values_id = pov.products_options_values_id and pa.options_id = 16 and pa.products_id = $ID ORDER BY pa.options_values_order";
  $queryexe = mysql_query($Query);
