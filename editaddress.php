        ...
        <td><table width="841" height="467" border="0" cellpadding="0" cellspacing="0" bgcolor="#002A72">
          <tr>
            <td width="179" height="467" valign="top" bgcolor="#3572B3"><!-- InstanceBeginEditable name="OrderSteps" --><img src="images/inner/step1-fade.jpg" width="179" height="51"><br>
              <img src="images/inner/Step2-login.jpg" width="179" height="105"><br>
                      ...
                      <tr>
                        ...
                        <td width="484">
						  <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                            <tr>
                              <td class="style16">Below is the information we have on file for you. You can edit any of the existing items or add a new item. </td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
						...
						<SCRIPT LANGUAGE="php">
						   ...
						   include "includes/editaddress.php";
                        </SCRIPT>
						</td>
                      </tr>
                      <tr>
                        ...
                        <td width="484">
						  <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                            <tr>
                              <td class="style17"><p><a href="revieworder.php"><img src="images/inner/back.jpg" width="68" height="25" border="0"></a></p>
                                <p><span class="style30">PRIVACY PROTECTION POLICY: The privacy and security of the information you provide is a priority at InkRockit. All personal information is kept on secured servers and will be used only for purposes relating to your transactions on this website. No information will be provided to outside sources or used for marketing or promotional purposes.</span><br>
                                      <br>
                                  </p></td>
                            </tr>
                          </table></td>
