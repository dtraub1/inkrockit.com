...
if (!empty($_SERVER['HTTP_REFERER'])) {
    ...
    if(!empty($parse_url['query']) && strpos($_SERVER['HTTP_REFERER'], $_SERVER['SERVER_NAME'])===FALSE){
        ...
        foreach($all as $val){
            $v = @explode('=', $val);
            if(!empty($v[0]) && ($v[0]=='q' || $v[0]=='keyword')){
...
<title>The Legal Size Pocket Folder Printing Experts</title>
            ...
            <td colspan="2" align="center" bgcolor="#0D2645"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="072e52">
              <tr>
                <td align="left" valign="middle" bgcolor="#0B294A"><p class="style18"><img src="images/adobe_icon.jpg" alt="" width="59" height="35" border="0" align="absmiddle">&nbsp;<a href="9x12_folders.php">9 x 12 Pocket Folder</a><br>
                  ...
                  </a><span class="style28"><img src="images/adobe_icon_selected.jpg" alt="" width="59" height="35" border="0" align="absmiddle"></span> 9 x 14.5 Legal Folder<br>
            ...
            <td width="446"><table width="492" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="23" background="images/index_new/priceleft.gif"><p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p></td>
                <td width="446" align="center" valign="top"><h1><a href="javascript:requestSamples();"><span class="style39"></span></a><a href="javascript:requestSamples();"><span class="style39"></span></a>Legal Size Folder 9&quot; x 14.5&quot;<img src="images/Legal_Folders.jpg" width="483" height="352" alt="6x9 folder"></h1>
                  <h1><span class="style46"><span class="style43">with Free Business Card &amp; CD Slits</span></span><span class="style7"><br>
