            ...
            <td height="467" valign="top" background="images/inner/bluevertline-wide.jpg" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="MainBody" -->
              <table width="503" border="0" cellspacing="0" cellpadding="0">
                ...
                <?
                    ...
                    $Query2 = "SELECT * FROM payment_book WHERE payment_book_id = " . $ID . " AND customers_id = " . $_SESSION['customers_id'];
                ...
                ?>
							<form name="form1" method="post" action="editpayment2.php">
							<input type="hidden" name="ID" value="<?print($ID);?>">
							<table width="95%"  border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="14" height="26"><img src="images/inner/login-orangecorner.jpg" width="14" height="26"></td>
								<td height="26" bgcolor="#FF6100"><span class="style29">EDIT PAYMENT </span></td>
							  ...
							  <tr>
								...
								<td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                                  <tr>
                                    <td colspan="2" class="style15">Payment Information - <span class="style31">(<span class="style33">*</span>) Indicates Required Field</span></td>
                                    </tr>
                                  <tr>
                                    <td width="35%" class="style17">Payment Identifier <span class="style15"><span class="style31"><span class="style33">*</span></span></span><br>
                                      (Ex. Visa - Business) </td>
                                    <td width="65%"><input name="Payment_Identifier" value="<?print($payment_identifier);?>" type="text" id="payment_identifier" size="30" maxlength="50"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Credit Card Type <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Credit_Card_Type" value="<?print($cctype);?>" type="text" id="cctype" size="30" maxlength="50"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Credit Card Number <span class="style15"><span class="style31"><span class="style33">*</span><br>(For security purposes, you will need to re-enter your credit card number.)</span></span></td>
                                    <td><input name="Credit_Card_Number" type="text" id="ccnumber" size="30" maxlength="50"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Expiration Date <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Expiration_Date" value="<?print($ccexpdate);?>" type="text" id="ccexpdate" size="25" maxlength="25"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Security Code <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Security_Code" value="<?print($ccseccode);?>" type="text" id="ccseccode" size="10" maxlength="10"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Name on Card <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Name_On_Card" value="<?print($nameoncard);?>" type="text" id="nameoncard" size="30" maxlength="50"></td>
                                  </tr>
                                </table>
								<p><br>
						            </p>
