...
if ($orderstatus == "Approved") {
	...
	if (strlen($_POST['credit_card_number']) != 0) {
	  $credit_card_number = substr($_POST['credit_card_number'],strlen($_POST['credit_card_number'])-4,strlen($_POST['credit_card_number']));
	} else {
	  $credit_card_number = "";
	}

    $sql = "INSERT INTO `inkrockit_orders` ( `name` , `company` , `address` , `city` , `state` , `zip` , `country` , `phone` , `fax` , `email` , `shipname` , `shipcompany` , `shipaddress` , `shipcity` , `shipstate` , `shipzip` , `shipcountry` , `size` , `inkcolors_side1` , `pmscolors_side1` , `pmsmetalcolors_side1` , `specialfinish_side1` , `foilstampoption_side1` , `emboss_side1` , `spotuv_side1` , `inkcolors_side2` , `pmscolors_side2` , `pmsmetalcolors_side2` , `specialfinish_side2` , `foilstampoption_side2` , `emboss_side2` , `spotuv_side2` , `diecut` , `velcrotabs` , `quantity` , `subtotal` , `shipping` , `shippingoption` , `total` , `credit_card_number` , `exp_month` , `exp_year` , `cardtype` , `sec_code` , `comments` , `orderdate` ) 
VALUES (
'".$_POST['Name']."', '".$_POST['Company']."', '".$_POST['Address']."', '".$_POST['City']."', '".$_POST['State']."', '".$_POST['ZIP']."', '".$_POST['Country']."', '".$_POST['Phone']."', '".$_POST['Fax']."', '".$_POST['Email']."', '".$_POST['ShipName']."', '".$_POST['ShipCompany']."', '".$_POST['ShipAddress']."', '".$_POST['ShipCity']."', '".$_POST['ShipState']."', '".$_POST['ShipZIP']."', '".$_POST['ShipCountry']."', '".$_POST['size']."', '".$_POST['inkcolors_side1']."', '".$_POST['pmscolors_side1']."', '".$_POST['pmsmetalcolors_side1']."', '".$_POST['specialfinish_side1']."', '".$_POST['foilstampoption_side1']."', '".$_POST['emboss_side1']."', '".$_POST['spotuv_side1']."', '".$_POST['inkcolors_side2']."', '".$_POST['pmscolors_side2']."', '".$_POST['pmsmetalcolors_side2']."', '".$_POST['specialfinish_side2']."', '".$_POST['foilstampoption_side2']."', '".$_POST['emboss_side2']."', '".$_POST['spotuv_side2']."', '".$_POST['diecut']."', '".$_POST['velcrotabs']."', '".$_POST['quantity']."', '".$_POST['subtotal']."', '".$_POST['shipping']."', '".$_POST['shippingoption']."', '".$_POST['total']."', 'XXXX-XXXX-XXXX-".$credit_card_number."', '".$_POST['exp_month']."', '".$_POST['exp_year']."', '".$_POST['cardtype']."', '".$_POST['sec_code']."', '".$_POST['comments']."', '".$today."');";
...
//	print ($mysql_error."<br><br>");
	...
	$Query = "SELECT id FROM inkrockit_orders ORDER BY id";
...
//	$headers .= "From: InkRockit <".$_POST['email'].">\r\n";
	...
	$message = $message . "Go to http://www.inkrockit.com/vieworder.php?nAuth=hef2185AK!&id=".$orderid." to view order information";
        ...
        <td valign="top">
          <div align="center">
            <? if ($orderstatus == "Declined") { ?>
              <font face="Verdana,Arial" >Your payment has been declined.  The reason given is:<br>
              <br>
              <? print ($response); ?></font>
              <? } else { ?>
              <font face="Verdana,Arial" ><span class="style66">Your order has been recorded.  To process your payment via PayPal, you must click on the "Process Payment via PayPal" button to complete the payment process.</span><br>
              <br>
                </font>
            </div>
...
<input type="hidden" name="business" value="paypal@inkrockit.com">
<input type="hidden" name="item_name_1" value="InkRockit Print Order #<? print ($orderid); ?>">
<input type="hidden" name="amount_1" value="<? print ($_POST['total']); ?>">
<input type="hidden" name="return" value="http://www.inkrockit.com/reg_rec.php?ID=<? print ($orderid); ?>">
<input type="hidden" name="invoice" value="<? print ($orderid); ?>">
<input type="hidden" name="no_shipping" value="1">
<input type="hidden" name="notify_url" value="https://www.inkrockit.com/recordpayment.php">
          <div align="center">
            <input type="submit" name="button" id="button" value="Process Payment via PayPal">
          </div>
        </form>
        ...
        <table width="100%" border="0" align="center">
            ...
            <tr>
              ...
              <td valign="top"><font face="Arial" size="-1">XXXX-XXXX-XXXX-<? print($credit_card_number); ?></font></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2" align="right"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td width="35%" valign="top" class="style8"><div align="right" class="style60"><strong>Pocket Folder Size:</strong></div></td>
                  <td colspan="2" class="style8"><span class="style60"><? print($_POST['size']); ?></span></td>
                </tr>
                <tr>
                  <td colspan="3" class="style7"><img src="images/index_new/graybar.gif" width="442" height="25"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="20%" valign="top" class="style8"><span class="style60"><? if ($_POST['foilstampoption_side1'] != 'None') { ?>Foil Stamp<? } ?></span></td>
                  <td width="45%" valign="top" class="style60"><span class="style60"><? if ($_POST['foilstampoption_side1'] != 'None') { ?><? print($_POST['foilstampoption_side1']); ?><? } ?></span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="3" class="style8"><span class="style7"><img src="images/index_new/graybar.gif" width="442" height="25"></span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" class="style8"><div align="right" class="style61">Special Treatments:</div></td>
                  <td valign="top" class="style8"><span class="style60"><? if ($_POST['foilstampoption_side2'] != 'None') { ?>Foil Stamp<? } ?></span></td>
                ...
                <tr>
                  <td colspan="3" class="style8"><span class="style7">Custom Options &amp; Quantities:</span></td>
                </tr>
                <tr>
                  <td valign="top" class="style8"><div align="right" class="style60"><strong>Die Cut:</strong></div></td>
                  <td colspan="2" class="style8"><span class="style60"><? print($_POST['diecut']); ?></span></td>
                </tr>
                <tr>
                  <td class="style8"><div align="right" class="style61">Velcro Tabs:</div></td>
                  <td colspan="2" class="style60"><span class="style60"><? print($_POST['velcrotabs']); ?></span></td>
                </tr>
                <tr>
                  <td class="style8"><div align="right" class="style61">Quantity Desired:</div></td>
                  <td colspan="2" class="style8"><span class="style60"><? print($_POST['quantity']); ?></span></td>
                </tr>
                <tr>
                  <td colspan="3" class="style8"><span class="style7"><img src="images/index_new/graybar.gif" width="442" height="25"></span></td>
                </tr>
                <tr>
                  ...
                  <td colspan="2" class="style60"><span class="style60"><? print($_POST['subtotal']); ?></span></td>
                </tr>
                <tr>
                  <td valign="top" class="style8"><div align="right"><span class="style7">Shipping:</span></div></td>
                  <td colspan="2" class="style60"><span class="style60"><? print($_POST['shipping']); ?></span></td>
                </tr>
                <tr>
                  <td class="style8"><div align="right"><span class="style7">TOTAL:</span></div></td>
                  <td colspan="2" class="style60"><span class="style60"><? print($_POST['total']); ?></span></td>
                </tr>
              </table></td>
              </tr>
          </table>
