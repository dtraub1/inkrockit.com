        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="503" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="227" height="317" valign="top" background="images/index_new/2pockets_1.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="8%">&nbsp;</td>
                ...
                <td width="276" height="317" valign="top" background="images/index_new/2pockets_2.jpg"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top">
              ...
              <tr>
                ...
                <td width="446" align="center" valign="top"><h2><strong>POCKET FOLDER (9&quot; x 12&quot;)</strong> </h2>
                  <p><span class="style7"><a href="javascript:requestSamples();"><img src="images/new/orangearrow.jpg" alt="" width="14" height="13" border="0" align="baseline">See, feel and touch the InkRockit Quality Difference!</a><br>
                    <img src="/folder_sample2.jpg" width="480" height="328"><br>
...
with 1 or 2 pockets</span>
                  ...
                  <h2>Legal Size Pocket Folder (9&quot; x 14.5&quot;) </h2>
