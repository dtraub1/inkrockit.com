                      ...
                      <tr>
						...
						<SCRIPT LANGUAGE="php">
                           include "includes/db_connection.php";
							...
							<form name="form1" method="post" action="addshipping2.php">
							<table width="95%"  border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td width="14" height="26"><img src="images/inner/login-orangecorner.jpg" width="14" height="26"></td>
								<td height="26" bgcolor="#FF6100"><span class="style29">ADD SHIPPING </span></td>
								...
								<td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                                  ...
                                  <tr>
                                    <td width="35%" class="style17">Address Identifier <span class="style15"><span class="style31"><span class="style33">*</span></span></span><br>
                                      (ex: Home, Work) </td>
                                    <td width="65%"><input name="Shipping_Identifier" type="text" id="addidentifier" size="30" maxlength="50"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">Company</td>
                                    <td width="65%"><input name="entry_company" type="text" id="entry_company" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">First Name <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_First_Name" type="text" id="entry_firstname" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">Last Name <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_Last_Name" type="text" id="entry_lastname" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">Street Address <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_Street_Address" type="text" id="entry_street_address" size="30" maxlength="64"></td>
                                  </tr>
                                  <tr>
                                    <td width="35%" class="style17">City <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td width="65%"><input name="Shipping_City" type="text" id="entry_city" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">State / Province <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Shipping_State" type="text" id="entry_state" size="30" maxlength="32"></td>
                                  </tr>
                                  <tr>
                                    <td class="style17">Postal Code <span class="style15"><span class="style31"><span class="style33">*</span></span></span></td>
                                    <td><input name="Shipping_Postal_Code" type="text" id="entry_postcode" size="10" maxlength="10"></td>
                                  </tr>
                                  <tr>
